<?php 
    ...
    // Working not error
            ...
            $check_user = "SELECT id_emp FROM tb_employee WHERE username = :username";
            $stmt = $connect->prepare($check_user);
            ...
            if($stmt->rowCount() > 0) {
                ...
                $query = "INSERT INTO tb_employee (username, emp_name, password, gender, salt, status, token, address) VALUES(:username, :emp_name, :password, :gender, :salt, :status, :token, :address)"  ;
